import { PORTD_READ_PORT, PORTD_WRITE_PORT, PortDaemonRequest } from "@home/_portresolver/portdaemonlib";
import { deregisterPort, generatePortsData, getPortNumber, registerPort, type Ports } from "@home/_portresolver/ports";
